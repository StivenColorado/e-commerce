<section class="row">
    ...
    <div class="mb-3 col-12">
        ...
        <select id="role" type="number" name="role" class="form-control bg-dark text-white @error('role') is-invalid @enderror">
    ...
    <div class="mb-3 col-6">
        ...
        <input id="number_id" type="number" name="number_id"
            class="form-control bg-dark text-white @error('number_id') is-invalid @enderror"
    ...
    <div class="mb-3 col-6">
        ...
        <input id="name" type="text" name="name" class="form-control bg-dark text-white @error('name') is-invalid @enderror"
    ...
    <div class="mb-3 col-6">
        ...
        <input id="email" type="text" name="email" class="form-control bg-dark text-white @error('email') is-invalid @enderror"
